...
if pathCheck == True:
        ...
        for bdir, dirs, files in os.walk(path):
        for fname in files:
        codeCheck = open(path + fname)# print("1") these are all debug prints, kinda like laps.if it prints the number, shows me how far it got before looping back
for lineNum, linePrint in enumerate(codeCheck): #print("2")
if lineNum == 2: #print("3")
