...
class Owner:
    ...
    async def repl(self, ctx):
        ...
        if ctx.channel.id in self.sessions:
            await ctx.send('Already running what the fuck do you think I am? Dyno? `.')
            return
    ...
    @commands.command()
    async def loadmod(self, ctx, *, module):
        """Loads a module."""
    ...
    @commands.command()
    async def unloadmod(self, ctx, *, module):
        """Unloads a module."""
        _module = f'bot.cogs.{module}'
        try:
    ...
    async def reloadmod(self, ctx, *, module):
        """Reloads a module."""
        _module = f'bot.cogs.{module}'
        try:
            self.bot.unload_extension(_module)
