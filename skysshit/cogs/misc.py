...
@commands.command(name='embed', description='embed command for embedding messages to be embeds',)
async def embed_command(self, ctx):
	...
	embed = discord.Embed(title=title, description=desc, color=random.choice(color_list))
